...
if __name__ == "__main__":
    ...
    all_y = torch.load(f"FiltrationLearningForPointClouds/data/{dataset}_label").type(torch.LongTensor)
    ...
    for CV_idx in range(CV_num):
        ...
        with torch.no_grad():
            ...
            print(valid_out.shape,type(valid_out),valid_out.dtype)
            print(validy.shape,type(validy),validy.dtype)

filename=exp_ModelNet_run_two_phase_ori
...
savedirname="result/${dataset}_rips${rips}_tr${toporep}_dtm${dtm}_PPM_repeat${nb_repeat}_dim${dim}_bs${bs}_pointnet${pointnet}_deepsets${deepsets}_pointmlp${pointmlp}_nnnew"
